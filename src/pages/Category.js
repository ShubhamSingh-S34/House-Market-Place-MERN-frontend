...
function Category() {
    ...
    useEffect(() => {
        const fetchListings = async () => {
            try {
                const response = await axios.get(`https://house-market-place-backend.onrender.com/api/listings/category/${params.categoryName}`);
                ...
                </p>
                {
                    loading ?
                        ...
                        listings && listings.length > 0 ?
                            ...
                            (<>
                                {console.log("Inside main", listings[0])}
                                <main>
